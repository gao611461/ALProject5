        ...
        area(content)
        {
            ...
            group(Step1)
            {
                ...
                group("Company Info Wizard")
                {
                    ...
                    {
                        Caption = 'Step1-1';
                        InstructionalText = ' This is Step 1-1';
                    }
                }
                group("Let's go!")
                {
                    ...
                    {
                        Caption = 'Step1-2';
                        InstructionalText = 'This is Step 1-2';
                    }
                }
            }
            ...
            {
                Caption = 'Step 2';
                InstructionalText = 'This is Step 2';
            ...
            group(Step3)
            {
                ...
                {
                    Caption = 'Step 3-1';
                    InstructionalText = 'This is Step 3';
                }
                group("That's it!")
                {
                    Caption = 'That''s it!';
